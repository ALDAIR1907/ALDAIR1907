<h1 align="center">Hola, Soy Aldair Hidalgo <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
  <a href="https://github.com/DenverCoder1/readme-typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Time+New+Roman&color=%23C8BE25&size=25&center=true&vCenter=true&width=600&height=100&lines=Estudiante+de+Ingeniería+de+Sistemas;Desarrollador+Full+Stack+en+Formación;Base+de+Datos;APIs+y+Microservicios;Especialista+en+Estructura+de+Datos;Resolver+Problemas;Tecnologias+e+Innovación;Amante+del+Código+Abierto;Futuro+Ingeniero+de+Sistemas"></a>
</p>
...
- 🎓 Actualmente soy `Estudiante` de [Ingeniería de Sistemas](https://www.utp.edu.pe/) en la [Universidad Tecnológica del Perú](https://www.utp.edu.pe/)
- 💻 `Egresado` de la carrera técnica de `Desarrollo de Software`
- :thinking: Estoy abierto a nuevas `oportunidades laborales` y `prácticas preprofesionales`.
- :technologist: Me encanta usar el Software como solución para cada `Problema`.
- :computer: Compitiendo en plataformas como `Codeforces`, `Atcoder`, `Leetcode`, `Codechef`.
- :fire: Apasionado por la `innovación tecnológica` y `soluciones eficientes`.
- :rocket: Enfocado en el `crecimiento profesional` y `desarrollo continuo`.
- :bulb: Interesado en `proyectos desafiantes` y `colaboraciones técnicas`.
<br>
